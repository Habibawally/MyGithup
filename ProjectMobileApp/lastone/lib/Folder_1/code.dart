...
import 'package:lastone/Folder_1/Homescreen.dart';
...
class _codeState extends State<code> {
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  fontSize: 14,
                  fontWeight: FontWeight.bold,
                  color: Color.fromARGB(255, 169, 225, 255),
                ),
                textAlign: TextAlign.center,
              ),
            ],
  ...
  Widget _textField({bool? first, last}) {
    return Container(
      height: 85,
      child: AspectRatio(
        aspectRatio: 1.0,
          ...
          decoration: InputDecoration(
            ...
            focusedBorder: OutlineInputBorder(
                borderSide: BorderSide(
                    width: 2, color: Color.fromARGB(255, 169, 225, 255)),
                borderRadius: BorderRadius.circular(12)),
          ),
        ),
      ),
